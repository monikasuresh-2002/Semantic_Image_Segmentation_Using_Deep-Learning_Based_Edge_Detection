...
if __name__ == '__main__':
    ...
    '''data'''    
    data_generator = load_data('C:/Users/H P/Downloads/5LSM0_CityscapesDataset-master/5LSM0_CityscapesDataset-master/datasets/citys', batch_size=batch_size, shuffle=True)
